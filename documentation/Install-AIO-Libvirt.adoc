...
There is a new installation (configuration) script I am working on to tighten up the install process the libvirt-nat AIO model.

[{format_cmd_exec}]
----
cd ~/RHEL9-Workshop
./sample-config/libvirt-nat/rhel9-workshop-installer.sh
----
