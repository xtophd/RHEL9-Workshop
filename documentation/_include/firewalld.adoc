...
The RHEL 9 firewall consists of:
  ...
  * firewall-cli : command line management utility
  * firewall-config : a GUI based management utility 
  * web-console : a WebUI based management utility

The firewalld service should already be configured and running:
...
The use of firewalld zones is considered out of scope for this workshop and will 
be discussed another time.  We will stick primarily to the defaults.
