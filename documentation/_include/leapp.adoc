...
----
yum-config-manager --disable my-rhel-8-server-rpms
...
[source,options="nowrap",subs="{markup-in-source}",role="copy"]
----
yum install -y leapp leapp-upgrade-el8toel9 cockpit-leapp

----

=== LEAPP Data

Delete any results from previous attempts to run leapp
