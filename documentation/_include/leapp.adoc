...
NOTE: For this exercise, _all_ automatic cut and paste commands will be directed to terminal 2 (lower terminal).  The intent is to dedicate terminal 2 to the leapp upgrade exercise, while using terminal 1 (upper terminal) for work in other exercises during the latter parts of the upgrade.
