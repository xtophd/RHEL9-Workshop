...
----
Startup finished in 783ms (kernel) + 1.560s (initrd) + 11.901s (userspace) = 14.246s
multi-user.target reached after 4.073s in userspace
----
...
[source,options="nowrap",subs="{markup-in-source}"]
----
9.036s kdump.service
2.204s sshd-keygen@rsa.service
 725ms dracut-initqueue.service
 577ms NetworkManager-wait-online.service
 571ms initrd-switch-root.service
 457ms systemd-hwdb-update.service
 336ms dnf-makecache.service
 269ms ldconfig.service
 235ms sssd.service
 190ms systemd-vconsole-setup.service
 125ms systemd-logind.service
 119ms firewalld.service
 115ms systemd-udev-trigger.service
 108ms initrd-parse-etc.service
